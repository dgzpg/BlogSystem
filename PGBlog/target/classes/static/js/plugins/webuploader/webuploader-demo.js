jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        // swf文件路径
        swf:'src/main/resources/static/js/plugins/webuploader/Uploader.swf',
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for(var i=0;i<data.length;i++){
                	pics+='<a class="fancybox" src="'+data[i].path+'"><img style="width: 254px; height: 143px;margin-right:5px;" alt="image" src="'+data[i].path+'" /></a>'
                	}
                }
				$(".pics").html(pics);
            },
