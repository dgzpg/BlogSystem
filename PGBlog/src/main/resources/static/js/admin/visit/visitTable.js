...
var fastToSearch = function(fastKey,status) {
...
var selectVisit = function() {
	$('#allVisit')
		.bootstrapTable(
			{
				method : 'post',
				url : "../selectVisitRecordListByPage",
				dataType : "json",
				...
				columns : [
					...
					},
					{
						...
						formatter : function(value, row,
							...
							var b = '<a  class=" btn-sm btn-danger"   onclick="addBlackIp(\'' + id + '\',\'' + ip + '\',\'' + area + '\',\'' + browser + '\',\'' + system + '\')"><i class="fa  fa-lock" ></i> 加入黑名单</a> ';
							return b;
						}
					} ]
			});
...
var addBlackIp = function(id, ip, area, browser, system) {
	var params = {
