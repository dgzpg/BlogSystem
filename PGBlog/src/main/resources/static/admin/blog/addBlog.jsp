...
<link th:href="@{/css/github-gist.css}"	rel="stylesheet">
...
<link rel="stylesheet"	th:href="@{/css/plugins/webuploader/webuploader.css}">
<link rel="stylesheet"	th:href="@{/css/plugins/webuploader/webuploader-demo.css}">
<link th:href="@{/css/fakeLoader.css}"	rel="stylesheet">
<style>
.news_infos span {
	font-size: 13px;
}
