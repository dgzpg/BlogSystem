		...
		$.ajax({
            ...
            success:function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                	...
                	time=i*0.05;
                	newBlog+='<li style="animation-delay:'+time+'s" class="animated fadeIn"><b><a href="selectBlogById?id='+id+'&user=2">'+data[i].title+'</a></b><p><span>'+data[i].introduction+'</span></p></li>';
                }
                // 初始化数据
