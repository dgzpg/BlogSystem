  ...
  <article style="opacity:1">
    ...
    <div class="lbox ">
        ...
        <div class="banner">
          ...
          <!-- 三个图片加链接 -->
            <li class="slide" style=" "><a
              href="https://www.4562.com/" target="_blank">
              <img src="/picture/1.png"></a></li>

            <li class="slide" style=" ">
            	<a href="javascript:void(0)" target="_blank">
            	<img src="${pageContext.request.contextPath}/images/2.jpg"></a></li>

            <li class="slide" style="">
           		 <a href="https://www.4562.com/" target="_blank">
          			  <img src="${pageContext.request.contextPath}/images/8db2f0313616ebe46ca5770769850b42.png">
          		</a>
          	</li>
      ...
      <div class="headline">
        ...
        <!-- 两个图片加文字加链接 -->
          <li>
	          	<a href="find/20400.html"title="【2019届校园招聘】如何准备互联网校招？">
	          		<img src="${pageContext.request.contextPath}/images/3ee0644472fa8556562ab3d8716b5316.jpg" alt="【2019届校园招聘】【2019届校园招聘】如何准备互联网校招？">
	          		<span>【2019届校园招聘】<br> 该如何准备互联网校招？</span>
	          	</a>
          </li>
          <li>
          		<a href="find/19873.html"title="【匆匆校园招聘季】总结校招经历的这几个月…">
          			<img  src="${pageContext.request.contextPath}/images/3f0b6da48a6fd4e626a021ff7bd0d74f.jpg"alt="【匆匆校园招聘季】总结校招经历的这几个月…">
          			<span>【匆匆校园招聘季】<br>总结校招经历的这几个月</span>
          		</a>
          </li>
        </ul>
      </div>
