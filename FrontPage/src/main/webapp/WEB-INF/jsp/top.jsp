  ...
  <div class="navbox">
    ...
    <nav>
      <ul id="starlist">
        ...
        <li><a href="/getList">技术博客</a></li>
        <li class="menu"><a href="/toResult?typeId=0">技术专栏</a>
          <ul class="sub">
            <li></li>
          </ul> <span></span></li>
        <li><a href="/toResource">资源分享</a></li>
...
<div class="searchbox">
  <div class="search">
    <form action="toSearch" name="searchform" method="post"
      id="searchform">
    ...
    $.ajax({
      ...
      success : function(data) {
          ...
          for (var i = 0; i < data.length; i++) {
            typeName += "<li><a href='toResult?typeId="+data[i].typeId +"'>"+ data[i].type + "</a></li>";
